    ...
    , m_skyboxTextureLocation(-1)
{
    ...
    Shader vertexShader = ShaderLoader(Shader::VertexShader).Load("D:/ITU/Graphics_programming_2025/graphics-programming-2025/exercises/exercise09/shaders/renderer/skybox.vert");
    Shader fragmentShader = ShaderLoader(Shader::FragmentShader).Load("D:/ITU/Graphics_programming_2025/graphics-programming-2025/exercises/exercise09/shaders/renderer/skybox.frag");
